<script>
  ...
  onMount(() => {
    // only run this if the firebase UI is not already initialized
    if (!document.querySelector(".firebaseui-card-content")) {
      firebase
        .auth()
        ...
        .then(() => {
          ...
          // run this only if the container isn't already initialized lol
